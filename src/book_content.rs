...
pub type BookNode = Node<WithContext<&'static str>, SimpleExtra, NodeChoice>;
...
pub fn get_book_content(textures: &Res<TextureAssets>) -> BookGraph {
    ...
    graph.add_node(
        0,
        Node::Fork {
            content: arc!("Érase una vez, un terrible dragón que atemorizaba la villa de Montblanc..."),
            choices: vec![
                NodeChoice {
                    text: arc!("Érase una vez, un hombre claramente disfrazado de dragón que, por algún motivo, atemorizaba la villa de Montblanc..."),
                ...
                NodeChoice {
                    text: arc!("Érase una vez, un dragón normalito, con sus problemas y sus cosas, cuya presencia atemorizaba la villa de Montblanc..."),
    ...
    graph.add_node(
        2,
        Node::Fork {
            content: arc!("Con la villa desesperada, el rey no tuvo más alternativa que hacer un sorteo para ofrecerle a la bestia sacrificios humanos, ignorando que el destino, confuso y sibilino, se conjuraría en su contra con el sacrificio de su propia hija...arc!("),
            choices: vec![
                NodeChoice {
    ...
    graph.add_node(
        ...
        Node::Simple {
            ...
            extra: SimpleExtra {
                illustration: textures.sensual_dragon_coming_out_of_cave.clone(),
        ...
        Node::Fork {
            ...
            choices: vec![
                NodeChoice {
                    ...
                    illustration: textures.jordi_dragon_accepts_princess.clone(),
                ...
                NodeChoice {
                    ...
                    illustration: textures.jordi_dragon_rejects_princess.clone(),
    ...
    graph.add_node(
        ...
        Node::Simple {
            ...
            extra: SimpleExtra {
                illustration: textures.princess_dragon.clone(),
    ...
    graph.add_node(
        ...
        Node::Simple {
            ...
            extra: SimpleExtra {
                illustration: textures.dragon_x_jordi_dragon.clone(),
    ...
    graph.add_node(
        ...
        Node::Simple {
            ...
            extra: SimpleExtra {
                illustration: textures.bevy.clone(), // TODO: What goes here?
    ...
    graph.add_node(
        ...
        Node::Simple {
            ...
            extra: SimpleExtra {
                illustration: textures.dragon_chases_jordi_dragon.clone(),
                additional_text: arc!(""),
            },
            next: None,
        },
        ...
        Node::Fork {
            ...
            choices: vec![
                NodeChoice {
                    ...
                    illustration: textures.bevy.clone(), // TODO: Handle no texture.
    ...
    graph.add_node(
        ...
        Node::Simple {
            content: arc!("Cleodolinda, como reprimenda, chamuscó un poco a Sant Jordi que huyó despavorido del reino. La Princesa volvió a la villa y todos celebraron su victoria."),
            extra: SimpleExtra {
                illustration: textures.dragon_chases_jordi_dragon.clone(), // TODO: This doesn't seem right.
                additional_text: arc!(""),
            },
            next: None,
        },
    ...
    graph.add_node(
        ...
        Node::Fork {
            ...
            choices: vec![
                NodeChoice {
                    text: arc!("...chivarse del romance al resto de la villa."),
                    illustration: textures.princess_thinking.clone(),
                    additional_text: arc!("Cotilla y morbosa, Cleodolinda corrió a la villa para compartir con el todo el mundo la aberrante y cómica relación contra natura que dragón y caballero estaban manteniendo."),
                    state_change: arc!({}),
                    next: arc!(42),
                },
    ...
    graph.add_node(
        ...
        Node::Simple {
            content: arc!("La villa se enteró del romance prohibido del dragón y Sant Jordi, lo que obligó a la pareja a vivir su luna de miel en Escocia"),
            extra: SimpleExtra {
                illustration: textures.dragon_x_sant_jordi.clone(),
                additional_text: arc!("Seguro que allí serían más tolerantes... "),
            },
            next: None,
        },
